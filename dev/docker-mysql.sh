...
docker exec master bash -c "puppet apply --detailed-exitcodes --parser future --hiera_config=/bigtop-mysql/hiera.yaml --modulepath=/bigtop-mysql/modules:/etc/puppet/modules:/usr/share/puppet/modules:/etc/puppetlabs/code/modules:/etc/puppet/code/modules /bigtop-mysql/manifests/site.pp"
